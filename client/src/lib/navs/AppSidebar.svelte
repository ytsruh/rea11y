<script>
  ...
  const links = [
    ...
    { name: "Run Test", link: "/app/test", icon: IoIosConstruct },
...
<div
  id="sidebar"
  class="w-64 min-h-full py-3 bg-white dark:bg-coal text-darkGrey dark:text-white hidden absolute lg:flex lg:static"
>
    ...
    <ul>
      {#each links as link}
        <li class="w-full">
          <a
            href={link.link}
            class="inline-flex my-1 p-3 rounded-md hover:bg-primary hover:text-white w-full"
          >
