...
<div class="my-3 px-2 bg-white dark:bg-coal rounded-md">
  <h2 class="text-2xl text-coal dark:text-white p-3">Create New Project</h2>
  <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
    ...
    <div class="md:col-span-5 p-3">
      <div class="mb-3 w-full">
        <label for="url" class="form-label inline-block mb-2 text-coal dark:text-white text-lg"
          >Description</label
        >
        <input
          type="text"
